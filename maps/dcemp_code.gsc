...
_id_B717()
{
    ...
    level.foley.name = "Sgt. Foley - USMC"; // here
    ...
    level.player setweaponammostock( "scar_h_thermal", 300 );
    level.player setweaponammostock( "scar_h_thermal", 9 );
...
_id_B72A()
{
    ...
    //var_1 character\character_usmc_rnd::main(); //here
