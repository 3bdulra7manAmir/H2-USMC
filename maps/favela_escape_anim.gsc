...
_id_C888()
{
    ...
    level.scr_model["player_bigjump"] = "worldbody_h1_usmc_desert"; //here
    level.scr_animtree["player_bigjump"] = #animtree;
    level.scr_model["player"] = "viewhands_player_usmc"; //here
    level.scr_animtree["player"] = #animtree;
    level.scr_animtree["worldbody"] = #animtree;
    level.scr_model["worldbody"] = "worldbody_h1_usmc_desert"; //here
    ...
    level.scr_model["viewhands"] = "viewhands_player_usmc"; //here
