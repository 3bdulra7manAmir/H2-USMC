...
main()
{
    ...
    _id_CDB1::main();
    maps\_load::set_player_viewhand_model( "viewhands_player_usmc" ); //here
    maps\_load::main();
    _id_B0E5::_id_C2BC();
...
_id_C93F()
{
    ...
    level._id_C904 character\character_usmc_assault_dcemp::main(); //here
    //level._id_C904 character\character_usmc_assault::main(); //here
